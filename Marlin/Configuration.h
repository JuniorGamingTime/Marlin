...
#define STRING_CONFIG_H_AUTHOR "(Juan Torres, 8-4-20, SKR 1.4 Turbo)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Hypercube 200"
 ...
 * Override with M92
 *                                      X, Y, Z, E0 [, E1[, E2...]] 150.59, 144.14 }
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 144.14, 150.59 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 100, 2000, 2000 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 31, 0 }
